defmodule HandlerTest do
  ...
  test "GET /wildlife" do
    ...
    assert response == expedected_response
  end
  ...
  test "GET /about" do
    ...
    <head>
      ...
      <title>Muzhawir's Wildthings Refuge</title>
    </head>

    <body>
      <h1>Muzhawir's Wildthings Refuge</h1>
  ...
  test "POST /bears" do
    ...
    Content-Length: 37\r
    \r
    Created a Brown bear named Bree bear!
    """
